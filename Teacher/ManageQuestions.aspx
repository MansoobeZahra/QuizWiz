...
<div style="border:1px solid #0078d4; padding:12px; background:#f0f7ff; margin-bottom:15px;">
    <strong style="color:#0078d4;">Filters:</strong><br />
...
<asp:GridView ID="gvQuestions" runat="server" AutoGenerateColumns="false" Width="100%"
    ...
    <Columns>
        ...
        <asp:TemplateField HeaderText="Difficulty">
            <ItemTemplate>
                <span style='color:<%# If(Eval("DifficultyLevel")="Hard" Or Eval("DifficultyLevel")="Expert", "red", "black") %>'>
        ...
        <asp:TemplateField HeaderText="Actions">
            ...
            <EditItemTemplate>
                <asp:LinkButton CommandName="Update" runat="server" Text="Save" style="color:green; font-weight:bold;" />
                |
