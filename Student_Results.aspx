<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Student_Results.aspx.vb" Inherits="Student_MyResults" %>
<!DOCTYPE html>
<html>
<head runat="server">
    <title>My Results - QuizWiz</title>
                    ...
                    <asp:GridView ID="gvDetail" runat="server" AutoGenerateColumns="false" Width="100%">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Your Ans">
                                <ItemTemplate>
                                    <span style='color:<%# If(Eval("Marks") > 0, "green", "red") %>'><%# Eval("StudentAns") %></span>
                                </ItemTemplate>
                            </asp:TemplateField>
